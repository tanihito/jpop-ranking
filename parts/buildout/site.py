...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/home/naoki/.buildout/eggs/distribute-0.6.15-py2.6.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/home/naoki/.buildout/eggs/distribute-0.6.15-py2.6.egg',
        '/home/naoki/.buildout/eggs/zc.buildout-1.5.2-py2.6.egg'
        ]
    ...
    original_paths = [
        '/usr/local/lib/python2.6/dist-packages/freebase-1.0.6-py2.6.egg',
